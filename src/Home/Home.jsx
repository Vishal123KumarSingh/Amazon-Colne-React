...
function Home() {
  const homeimages = [
    ...
    // },
    { url: "https://m.media-amazon.com/images/I/61c7woqdtkL._SX3000_.jpg" },
    { url: "https://m.media-amazon.com/images/I/61OGc9zgsyL._SX3000_.jpg" },
    { url: "https://m.media-amazon.com/images/I/61oxi2NU2PL._SX3000_.jpg" },
    { url: "https://m.media-amazon.com/images/I/61MECemNcuL._SX3000_.jpg" },
  ];
  return (
    <div className="home">
        ...
        <div>
          <SimpleImageSlider
            style={{
              marginBottom: "300px",
              backgroundColor:
                "linear-gradient(to bottom, rgba(0, 0, 0, 1), rgb(228, 209, 209, 0))",
            }}
            width={"100%"}
            height={"90%"}
            images={homeimages}
